...
namespace HTTPHandler
{
    public partial class HTTP : IDisposable
    {
        ...
        public Action<object, HTTPResponse> DataRequestComplete { get; set; }

        public Action<object, HTTPReadComplete> FileReadComplete { get; set; }
        
        public Action<object, HTTPProgress> DownloadProgress { get; set; }
        public Action<object, HTTPComplete> DownloadComplete { get; set; }
